...
Impstation's rules are divided into 4 categories. Use the links below to read them.

- [Section A: Core Rules](./cat-a.md)
- [Section B: Roleplay Rules](./cat-b.md)
- [Section C: Metashield](./cat-c.md)
- [Section D: Command, Security, Antagonist, and Silicon Rules](./cat-d.md)