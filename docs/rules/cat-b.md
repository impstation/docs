...
- **The Lowpop Clause:** In the absence of Command or Security departments, crew members are encouraged to organize in such a way to ensure compliance with space law.
...
- **Good:** Attempting to apprehend an antagonist while there are no members of Command or Security on the station.
...
- **Bad:** "Validhunting" or engaging in "selfsec": **hunting** for antagonists or lawbreakers, or preparing to defend someone else from someone who has been trying to kill a random crewmember, without being a member of Security in a round where there are players in the Security department.
...
- Non-security personnel should not seek to kill or detain threats. You should generally attempt to flee from combat or dangerous situations. Remember that your character likely fears injury or death. This rule is loosened when there are no members of Security or Command on the station.
...
For more information, see the [Escalation Table](./escalation.md).
